...
void ResVsMom::process()
{
  
}

void ResVsMom::fillGraph(TGraphErrors& graph1, const char* fileNameTemplate, double min, double max, double step, double guessA = 0.08, double guessB = 0.21)
{
  TTree* genTree;
  TTree* recTree;
