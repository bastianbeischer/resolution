// $Id: RES_DetectorConstruction.hh,v 1.16 2010/01/09 13:44:57 beischer Exp $
...
public:
  ...
  RES_Module* GetModule(unsigned int i) {assert(i < m_modulesNew.size()); return m_modulesNew.at(i);}
 
  void AddModulePlacement(G4ThreeVector where) {m_modulesNew.push_back(new RES_Module(where));}
...
private:
  ...
  std::vector<RES_Module*>        m_modulesNew;
